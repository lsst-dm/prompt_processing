...
RUN groupadd -g 4085 -o rubin_users \
    && useradd -u 48047 -g 4085 rubinpp \
    # Ensure that the target directories and files created by this Dockerfile are owned by rubinpp
    && chown -R rubinpp:rubin_users $APP_HOME
USER rubinpp
# Create /home/rubinpp/.eups directory in the container
