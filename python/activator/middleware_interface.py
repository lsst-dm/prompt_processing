...
class MiddlewareInterface:
    ...
    @staticmethod
    def _get_dimension_records_to_export(src_butler: Butler, **kwargs) -> GroupedDimensionRecords:
        ...
        **kwargs
        ...
        records = {}
        for dimension in dimensions:
            records[dimension.name] = src_butler.query_dimension_records(dimension, explain=False, **kwargs)
        return records
